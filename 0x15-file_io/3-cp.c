...
/**
 * check98 - it checks that file_from exists and can be read
...
/**
 * check99 - it checks that file_to created and/or can be written to
 * @check: it checks if true of false
...
/**
 * check100 - it checks that file descriptors were closed properly
